    ...
    return (
      <SelectCont>
        ...
        <SelectStyled onChange={handleChange} defaultValue="role" name={name} className="SelectField" >
          ...
          <option value="Plan 1 mes - $30.00" className="op">Plan 1 mes - $30.00</option>
          <option value="Plan 3 meses - $75.00" className="op">Plan 3 meses - $75.00</option>
          <option value="Plan 6 meses - $120.00" className="op">Plan 6 meses - $120.00</option>
         </SelectStyled>
        </SelectCont>
    )
  }
